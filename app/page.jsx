                  ...
                  <CardContent className="pt-2">
                    <div className="flex flex-col space-y-4">
                      <div className="flex items-center space-x-4">
                        <div className="relative w-12 h-12 flexshrink-0">
                          <Image
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">Find asnwers to common questions about our platform</p>
          </div>
        ...
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
              Join thosands of professionals who are advancing their careers with AI-Powered guidance.
            </p>
